object ChoosePostavF: TChoosePostavF
  Left = 644
  Top = 352
  BorderStyle = bsToolWindow
  Caption = 'ChoosePostavF'
  ClientHeight = 201
  ClientWidth = 464
  Color = clBtnFace
  ...
  object Label1: TLabel
    ...
    Width = 247
    Height = 16
    Caption = #1042#1099#1073#1077#1088#1080#1090#1077' '#1087#1086#1089#1090#1072#1074#1097#1080#1082#1072'  '#1080#1079' '#1089#1087#1080#1089#1082#1072
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clBlue
    Font.Height = -13
    Font.Name = 'MS Sans Serif'
