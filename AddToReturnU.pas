  ...
  begin
    ...
    begin
      try
        ...
        SQL.Add('declare @iddoc int set @iddoc = ' + ReturnToProviderF.qInternalNakl.FieldByName('iddoc').AsString);
        ...
        SQL.Add('declare @art_code int set @art_code = ' + ReturnToProviderF.qInternalNakl.FieldByName('art_code').AsString);
        ...
        SQL.Add('declare @id_postav uniqueidentifier set @id_postav = ''' + ReturnToProviderF.qInternalNakl.FieldByName('id_postav').AsString + '''');
        ...
        SQL.Add('    SrokGodn,   cena_zakup, id_AgrKontrag)');
        SQL.Add('  select');
        ...
        SQL.Add('    i.SrokGodn, s.CenaZakup, j.id_AgrKontrag');
        SQL.Add('  from');
        SQL.Add('    JMOVES j (nolock)');
        SQL.Add('    left join rTovar r (nolock) on r.IDDOC=j.IDDOC');
        SQL.Add('    inner join SPRTOV s (nolock) on s.KOD_NAME=r.KOD_NAME');
        ...
        SQL.Add('    s.ostat, t_k.kol_new, j.id_AgrKontrag');
        SQL.Add('');
  ...
  begin
    ...
    begin
      try
        ...
        SQL.Add('  id_AgrKontrag = '+ReturnToProviderF.qInternalNakl.FieldByName('id_AgrKontrag').AsString);
        SQL.Add('');
  ...
  begin
    ...
    begin
      try
        ...
        SQL.Add('set @art_code = '+ReturnToProviderF.qInternalNakl.FieldByName('art_code').AsString);
        SQL.Add('');
        SQL.Add('select');
        SQL.Add('  *');
        SQL.Add('from');
