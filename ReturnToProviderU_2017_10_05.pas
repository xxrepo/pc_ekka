...
//      MessageDlg('„то-то пошло не так.'+#13+'”бедитесь, что все товары к возврату подготовлены '+#13+'и повторите формирование возвратной накладной!',mtError,[mbOK],0);
        MessageDlg('”бедитесь, что все товары к возврату подготовлены '+#13+'и повторите формирование возвратной накладной!'+#13+'ќшибка сервера: '+E.Message,mtError,[mbOK],0);
        ReturnToProviderF.Close;
        exit;
      end;
    end;
    ...
    begin
//      MessageDlg('„то-то пошло не так.'+#13+'”бедитесь, что все товары к возврату подготовлены '+#13+'и повторите формирование возвратной накладной!',mtError,[mbOK],0);
      MessageDlg('”бедитесь, что все товары к возврату подготовлены '+#13+'и повторите формирование возвратной накладной!',mtError,[mbOK],0);
      ReturnToProviderF.Close;
      exit;
    end;
