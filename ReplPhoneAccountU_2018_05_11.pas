...
//  TmpFilePrefix = '~Ek'#0;
  PHONE_CODES_TO_SERVICE_ID: array[1..13] of TPhoneCodes_To_ServiceID = ((PhoneCode:'050';ServiceID:'927';ProviderName:'Vodafone';Color:clRed),//mts
...
uses
  ReplConnectionEditU, DataModuleU, EKKAU, ShareU;
...
begin
  ...
  if Key = VK_RETURN then edAmount.SetFocus;
end;
...
begin
  ...
  for i:=1 to length(PHONE_CODES_TO_SERVICE_ID) do
...
procedure TReplPhoneAccountF.FillAuthResponse(auth_res: ansistring);
var
...
procedure TReplPhoneAccountF.service(var err: boolean);
var
  TmpPathLength, TmpFileLength: cardinal;
  TmpPath, TmpFile: ansistring;
  TmpPathLen,TmpFileLen: LongInt;
