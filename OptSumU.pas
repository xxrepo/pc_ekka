...
var Nm,Mess:String;
 ...
 begin
  ...
  try
   ...
   if Not EKKA.fpCloseFiscalReceipt(StrToCurr(Edit1.Text),4,StrToCurr(Edit1.Text),0,false,0,StrToIntDef(MainF.RRN,1),MainF.BankCard) then AbortM('Ошибка закрытия чека: '+EKKA.LastErrorDescr);
