object FarmZamAndSoputstvF: TFarmZamAndSoputstvF
  ...
  object pcFarmZamAndSoputstv: TPageControl
    Left = 4
    Top = 28
    Width = 337
    Height = 157
    ActivePage = tsFarmZam
    TabOrder = 4
    object tsFarmZam: TTabSheet
      Caption = #1060#1072#1088#1084'.'#1079#1072#1084#1077#1085#1099
    ...
    object tsSoputstv: TTabSheet
      Caption = #1057#1086#1087#1091#1090#1089#1090#1074#1091#1102#1097#1080#1077
      ImageIndex = 1
      object dgSoputstvCount: TDBGrid
        Left = 4
        Top = 4
        Width = 320
        Height = 120
        DataSource = DM.dsSoputstvCount
        TabOrder = 0
        TitleFont.Charset = DEFAULT_CHARSET
        TitleFont.Color = clWindowText
        TitleFont.Height = -11
