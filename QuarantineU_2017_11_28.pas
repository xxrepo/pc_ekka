...
uses
  ...
  DBGrids, Classes, SysUtils, DateUtils, Dialogs, Windows;
...
const
  ...
  NOTIFICATION_RETURN_TO_PROVIDER = 'Если товары необходимо вернуть в поставщику - нажмите кнопку "Вернуть поставщику"';
  LEFT_INDENT = 12;
...
//    end;
    ...
    if pnlReturnOrders.Visible then
    begin
      if pnlReturnOrders.Height<200 then
        pnlReturnOrders.Height:=200;
      if Splitter1.Top<200 then
        Splitter1.Top:=200;
    end;
