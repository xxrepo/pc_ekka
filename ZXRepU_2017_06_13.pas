...
uses Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
     Dialogs, ExtCtrls, StdCtrls, Buttons, EKKAU, Util, ComCtrls;
...
uses MainU, ShareU, DataModuleU, DB;
 ...
 begin
  ...
  if EKKA.EmulEKKA=False then
   begin
    ...
    EKKA.fpSetTime(Now);
    if EKKA.TypeEKKA=EKKA_MARRY301MTM then MainF.ShowErrorEKKA(EKKA.fpZeroCheck);
   end else begin
             EKKA.fpZRep;
             EKKA.fpZeroCheck;
            end;
