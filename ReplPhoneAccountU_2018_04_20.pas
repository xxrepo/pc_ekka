...
uses MainU, ReplConnectionEditU, DataModuleU, EKKAU, ShareU;
...

{
      ...
      begin
        ...
        MessageDlg('Информация о платеже не была сохранена в БД!'+#13+'Запрос на запись в БД: '+ReplPhoneAccountF.qSaveReplenishment.SQL.Text+#13+'Обратитесь в IT-отдел!',mtError, [mbOK],0);
        EnableControls;
      end;
    end;
  end;
