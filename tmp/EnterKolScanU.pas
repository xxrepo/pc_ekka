...
type
  ...
  TEnterKolScanF = class(TForm)
    ...
    procedure edKolKeyDown(Sender: TObject; var Key: Word;
      Shift: TShiftState);
...
procedure TEnterKolScanF.edKolKeyDown(Sender: TObject; var Key:Word; Shift:TShiftState);
 begin
  if Key=VK_RETURN then BitBtn1Click(BitBtn1);
 end;

procedure TEnterKolScanF.FormActivate(Sender: TObject);
 begin
  tmpV:=edKol.Text;
 end;
