...
var
 ...
 begin
  ...
  begin
    ...
    PrintRep.AddText(#10);
    PrintRep.AddText(#10);
    PrintRep.AddText('Товары в заказе: '+#10);
    //Таблица
    PrintRep.Font.Size:=4;
    ...
    PrintRep.Font.Size:=4;
    //Саша Малахов 02.08.2018 звонил (Сергею Хора?) и выяснил, что
    //Итого за заказ - это оплата страховой, а франшиза и сумма заказа никак не влияет на итого
    PrintRep.Font.Style:=[fsUnderline];
    PrintRep.AddText('Итого за заказ: '+CurrencyToStr(DM.qrRes.FieldByName('Bezn1').AsCurrency) +' грн.'+#10);
    PrintRep.Font.Style:=PrintRep.Font.Style-[fsUnderline];
