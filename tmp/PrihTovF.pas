...
var ID:Integer;
 begin
  try
   ...
   DM.qrScanN.SQL.Add('      left join ScanNakl b on a.art_code=b.art_code and a.nn_nakl=b.nn_nakl and a.date_nakl=b.date_nakl left join SprUser c on b.id_user=c.id');
