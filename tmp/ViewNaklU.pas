...
uses Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
     Dialogs, ComCtrls, StdCtrls, ExtCtrls, Buttons, Grids, DBGrids, Util,
     DBCtrls, DB, PrintReport, Menus, ShowTextU;
...
//   BitBtn6.Enabled:=rbPr.Checked;
   ...
   if rbPr.Checked then tn:=IntToStr(DC_INCOME)
                   else tn:=IntToStr(DC_BACK);
