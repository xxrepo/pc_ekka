...
uses
  ...
  Dialogs, StdCtrls, Buttons, Util, Grids, DBGrids, DBCtrls;
...
type
  ...
  public
    ...
    property NewGrafik:Boolean read FNewGrafik write FNewGrafik;
 ...
 begin
  if NewGrafik then
   begin
    ...
    RadioButton4.Top:=RadioButton4.Top-60;
    RadioButton7.Top:=RadioButton7.Top-60;
    RadioButton8.Top:=RadioButton8.Top-60;
    RadioButton6.Top:=RadioButton6.Top-60;
...
procedure TAETabF.RadioButton9Click(Sender: TObject);
 begin
  if (NewGrafik=False) or (DM.qrWorkPos.IsEmpty) then
   begin
    edStart.Text:='0';
    edStMin.Text:='00';
    edEnd.Text:='0';
    edEndMin.Text:='00';
             ...
             edStart.Text:=Copy(DM.qrWorkPos.FieldByname('time_beg').AsString,1,2);
             edStMin.Text:=Copy(DM.qrWorkPos.FieldByname('time_beg').AsString,4,2);
             edEnd.Text:=Copy(DM.qrWorkPos.FieldByname('time_end').AsString,1,2);
             edEndMin.Text:=Copy(DM.qrWorkPos.FieldByname('time_end').AsString,4,2);
            end;
