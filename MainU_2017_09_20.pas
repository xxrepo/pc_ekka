...
Uses
  ...
  OpenLib, Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls,
  Forms, Dialogs, Menus, ExtCtrls, ComCtrls, StdCtrls, Util, Grids, DBGrids,
  {StdActns, }
  ActnList,
  {DBActns, }
  DB, Buttons, ADODB, Digits, ComObj,
  {AdoInt, }
  EKKAU, IniFiles, PrintReport,
  {USBEject, }
  IdMessage, IdBaseComponent, IdComponent, IdTCPConnection, IdTCPClient, IdMessageClient, IdSMTP,
  ClipBrd, ExecCommU,
  {VCLUnZip, }
  VCLZip, jpeg, ShellApi, DBCtrls, Volume, DateUtils,
  {Mask, }{IdPOP3, }{IdHTTP, }{IdIOHandler, }{IdIOHandlerSocket, }{IdSSLOpenSSL, }
  {EncdDecd, }
  SendReceiveXML,
  {InvokeRegistry, }{SOAPHTTPClient, }
  SOAPHTTPTrans, OpenOffice, Types,
  {Printers, }
  svButtons, Math, IdTCPServer, Registry, MPlayer, SHDocVw,
  CPDrv, {RpDefine, }{RpRender, }{RpRenderCanvas, }{RpRenderPreview, }
  ImageEn, ExtImage, StrUtils;
