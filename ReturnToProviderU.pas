...
begin
  ...
  begin
    ...
    begin
      ...
      SQL.Add('declare @iddoc int set @iddoc = '+IntToStr(IDDoc));
      SQL.Add('select');
      ...
      SQL.Add('  i.srokgodn as srokgodn, j.id_AgrKontrag');
      SQL.Add('from');
      ...
      SQL.Add('  i.srokgodn, j.id_AgrKontrag');
    ...
    try
      ...
      begin
        try
          ...
          SQL.Add('set @pid_user = ' + IntToStr(Prm.UserID));
          SQL.Add('');
          SQL.Add('select');
          SQL.Add('  *');
          SQL.Add('from');
    ...
    try
      ...
      begin
        try
          ...
          SQL.Add('  NumSeriya, SrokGodn, CompName, ID_Gamma, F_NDS, id_AgrKontrag)');
          SQL.Add('');
          SQL.Add('  select');
          SQL.Add('    newid(),   getdate(),   '+IntToStr(Prm.AptekaID)+', ');
          SQL.Add('    id_postav, nn_prih, dt_prih, id_part8, KOD_NAME, ART_CODE,');
          SQL.Add('    NAMES, ART_NAME, KOL, CENA, cena_zakup, pr_vz, VzDescr, ');
          SQL.Add('    NumSeriya, SrokGodn, host_name(), '+IntToStr(Prm.ID_Gamma)+', F_NDS, id_AgrKontrag');
          SQL.Add('  from');
          SQL.Add('    chk_vozr');
          SQL.Add('  where');
