object DM: TDM
  ...
  object qrChek: TADOQuery
    ...
    SQL.Strings = (
      ...
      '       a.CenaP,'
      ''
      '       Sum(a.SumSkd-(a.kol*a.cena-a.kol*a.cenap)) as SumSkdP,'
      ''
      '       Max(b.P1) as P1,'
      '       Max(b.P2) as P2,'
      '       Max(b.P3) as P3,'
  ...
  object qrShowNakl: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select j.nn_nakl,j.date_nakl,b.names,b.art_code,Sum(a.kol) as ko' +
        'l,a.cena,j.f_nds,'
      '       IsNull(Sum(a.IsScan),0) as IsScan,'
      '       Max(j.Priznak) as Priznak,'
      '       Max(a.shtrih) as Box'
      ''
      'from Jmoves j (nolock),'
      '     rTovar a (nolock),'
      '     SprTov b (nolock)'
      ''
      'where j.iddoc=:iddoc and a.iddoc=j.iddoc and'
      '      a.kod_name=b.kod_name'
      
        'group by b.names,b.art_code,j.nn_nakl,j.date_nakl,a.cena,j.f_nds' +
        ',j.iddoc'
      ''
      ''
      '')
  ...
  object qrPList: TADOQuery
    ...
    SQL.Strings = (
      ...
      'where art_code>1 and'
        ...
        '      art_code not in (select art_code from SprTov where ostat>0' +
        ' group by art_code)'
      ''
      'order by names')
    Left = 70
  ...
  object ADOCoTest: TADOConnection
    CommandTimeout = 300
    ConnectionString = 
      'Provider=SQLNCli.1;Password=;Persist Security Info=True;User ID=' +
      'sa;Initial Catalog=APTEKA_NET;Data Source=SERGEY'
    ConnectionTimeout = 3
    LoginPrompt = False
    Provider = 'SQLNCli.1'
    Left = 20
