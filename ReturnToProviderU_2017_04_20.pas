      ...
      Open;
{
      ...
      SQL.Add('  sum(r.KOL) as kol, max(r.CenaZakup) as cena, r.SHTRIH as SHTRIH, max(r.CENAP) as cenap, r.pr_vz_post as pr_vz_post, r.ISSCAN as ISSCAN, ');
//      SQL.Add('  sum(r.KOL) as kol, max(r.CENA) as cena, r.SHTRIH as SHTRIH, max(r.CENAP) as cenap, r.pr_vz_post as pr_vz_post, r.ISSCAN as ISSCAN, ');
      SQL.Add('  s.NAMES as names, s.ART_CODE as art_code, s.ART_NAME as ART_NAME, sum(s.ostat) as ostat,');
